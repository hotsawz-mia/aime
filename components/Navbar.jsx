...
export default function Navbar() {
  return (
    ...
    <div
      data-theme="synthwave"
      className="navbar bg-base-300 shadow-lg sticky top-0 z-50 relative"
    >
      {/* Left: Home + About */}
      <div className="navbar-start gap-2">
        {/* Home button (icon) */}
        <Link href="/" className="btn btn-ghost btn-circle text-base-100 hover:!bg-transparent active:!bg-transparent focus:!bg-transparent text-success" aria-label="Homepage">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 border-success" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <path className="border-success" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l9-7 9 7v8a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1v-8z" />
          </svg>
        </Link>
